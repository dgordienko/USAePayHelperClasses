...
namespace KlikNPayPaymentUnit
{
	...
	/// Batch upload file.
	/// </summary>
	public sealed class BatchUploadFile : List<BatchUploadRecord>{
	...
	/// Batch upload record.
	/// </summary>
	public sealed class BatchUploadRecord : IUsaEPayFields
	{
		...
		public string vcdlstate
		{
			get;set;
		}

		public string vcrouting
		{
			get;set;
		}
